...
wi_2016 <- read_csv("openelections-data-wi/2016/20161108__wi__general__ward.csv")
wi_2012_general <- read_csv("openelections-data-wi/2012/20121106__wi__general__ward.csv")
wi_2012_gov <- read_csv("openelections-data-wi/2012/20120605__wi__general-recall__ward.csv")
wi_2012 <- bind_rows(wi_2012_general, wi_2012_gov)
rownames(wi_2012) <- NULL
wi_2008 <- read_csv("openelections-data-wi/2008/20081104__wi__general__ward.csv")
wi_2004 <- read_csv("openelections-data-wi/2004/2004_wi_pres.csv")
wi_2000 <- read_csv("openelections-data-wi/2000/2000_wi_pres.csv")
...
ga_2016 <- read_csv("openelections-data-ga/2016/20161108__ga__general.csv")
ga_2012 <- read_csv("openelections-data-ga/2012/20121106__ga__general.csv")
ga_2008 <- read_csv("openelections-data-ga/2008/20081104__ga__general.csv")
ga_2004 <- read_csv("openelections-data-ga/2004/20041102__ga__general.csv")
ga_2000 <- read_csv("openelections-data-ga/2000/20001107__ga__general.csv")
...
pa_2016 <- read_csv("openelections-data-pa/2016/20161108__pa__general_county.csv")
pa_2012 <- read_csv("openelections-data-pa/2012/20121102__pa__general__county.csv")
pa_2008 <- read_csv("openelections-data-pa/2008/20081104__pa__general__county.csv")
pa_2004 <- read_csv("openelections-data-pa/2004/20041102__pa__general__county.csv")
pa_2000 <- read_csv("openelections-data-pa/2000/20001107__pa__general__county.csv")
...
az_2012 <- read_csv("openelections-data-az/2012/20121106__az__general.csv")
az_2008 <- read_csv("openelections-data-az/2008/20081104__az__general.csv")
az_2004 <- read_csv("openelections-data-az/2004/20041102__az__general.csv")
az_2000 <- read_csv("openelections-data-az/2000/20001107__az__general.csv")
