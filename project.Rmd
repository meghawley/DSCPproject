...
server <- function(input, output) {
  ...
  swing_elec_filtered <- reactive({
    swing_elec %>% 
      filter(state %in% input$states, year %in% input$year)
  })
